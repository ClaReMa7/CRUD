...
<div class="container pb-6 pt-6">
    ...
    include "./app/views/include/btn_back.php";
    ...
    ?>
        ...
        <div class="columns">
            <div class="column is-two-fifths container-center">
                <?php if (is_file("./app/views/photos/" . $datos['usuario_foto'])) { ?>
                    <figure class="image mb-6">
                        <img class="is-rounded" src="<?php echo APP_URL; ?>app/views/photos/<?php echo $datos['usuario_foto']; ?>">
                    </figure>
                ...
                <?php } else { ?>
                    <figure class="image mb-6 container-center">
                        <img class="is-rounded" src="<?php echo APP_URL; ?>app/views/photos/avatar-user.png">
                    </figure>
                <?php } ?>
            </div>
    ...
    <?php
        ...
        include "./app/views/include/error_alert.php";
    }
    ?>
</div>